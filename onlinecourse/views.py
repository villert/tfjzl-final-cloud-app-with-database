...
class CourseDetailView(generic.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        user = self.request.user
        context['is_enrolled'] = user.is_authenticated and check_if_enrolled(user, course)
        return context
...
def show_exam_result(request, course_id, submission_id):
    ...
    questions = course.lesson_set.order_by('order').prefetch_related(
    ...
    grade = int((earned_grade / total_grade) * 100) if total_grade else 0
    context = {
        'course': course,
